...
ALTER TABLE tickets ADD original_date_created DATETIME NOT NULL;

DROP VIEW IF EXISTS full_tickets;
...
SELECT
  ...
  t.original_date_created as original_date_created
FROM tickets t
...
DROP VIEW IF EXISTS full_all_tickets;
...
UPDATE tickets SET original_date_created=UTC_TIMESTAMP();

# --- !Downs

ALTER TABLE tickets DROP COLUMN original_date_created;
