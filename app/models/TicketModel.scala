...
object TicketModel {
   ...
   * Create a ticket.
   */
  def create(userId: Long, ticket: Ticket): Option[FullTicket] = {
   ...
   */
  def update(
    userId: Long, id: String, ticket: Ticket,
